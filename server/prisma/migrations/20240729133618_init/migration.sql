...
CREATE TABLE `History` (
    ...
    UNIQUE INDEX `History_userId_locationId_searchedAt_key`(`userId`, `locationId`, `searchedAt`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `History` ADD CONSTRAINT `History_locationId_fkey` FOREIGN KEY (`locationId`) REFERENCES `Location`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
